...
public class WaypointScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        ...
        for (Row r : rows) {
            ...
            r.main.extractRenderState(g, mouseX, mouseY, partialTick);
            r.hide.extractRenderState(g, mouseX, mouseY, partialTick);
            r.fav.extractRenderState(g, mouseX, mouseY, partialTick);
            r.send.extractRenderState(g, mouseX, mouseY, partialTick);
            r.del.extractRenderState(g, mouseX, mouseY, partialTick);
        ...
        search.extractRenderState(g, mouseX, mouseY, partialTick);
        tabAllBtn.extractRenderState(g, mouseX, mouseY, partialTick);
        tabDeathBtn.extractRenderState(g, mouseX, mouseY, partialTick);
        tabFavBtn.extractRenderState(g, mouseX, mouseY, partialTick);
        tabGlobalBtn.extractRenderState(g, mouseX, mouseY, partialTick);

        addBtn.extractRenderState(g, mouseX, mouseY, partialTick);
        settingsBtn.extractRenderState(g, mouseX, mouseY, partialTick);
        doneBtn.extractRenderState(g, mouseX, mouseY, partialTick);
    ...
    private static void drawCenteredIcon(GuiGraphicsExtractor g, Button btn, Identifier icon) {
