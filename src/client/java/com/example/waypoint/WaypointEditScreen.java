...
public class WaypointEditScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        ...
        // labels
        g.text(this.font, Component.translatable("screen.waypointmod.name"), left, 24, 0xFFAAAAAA, false);
        g.text(this.font, Component.translatable("screen.waypointmod.xyz"), left, 52, 0xFFAAAAAA, false);
        g.text(this.font, Component.translatable("screen.waypointmod.color"), left, 84, 0xFFAAAAAA, false);
        ...
        g.text(this.font, Component.literal(hex), previewX, previewY + 22, 0xFFFFFFFF, false);
    ...
    private void drawSVSquare(GuiGraphicsExtractor g, int x, int y, int svH) {
    ...
    private void drawHueBar(GuiGraphicsExtractor g, int x, int y, int svH) {
        for (int yy = 0; yy < svH; yy += DRAW_STEP) {
    ...
    private void drawSVMarker(GuiGraphicsExtractor g, int svX, int svY, int svH) {
    ...
    private void drawHueMarker(GuiGraphicsExtractor g, int hueX, int hueY, int svH) {
    ...
    private void drawPreview(GuiGraphicsExtractor g, int x, int y, int rgb) {
